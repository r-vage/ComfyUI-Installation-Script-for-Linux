...
### Fixed
- Reusing an existing launcher name now updates its Bash, Zsh, Fish, or PowerShell profile entry to the newly selected ComfyUI installation instead of leaving the old target in place

**Changed files:** `install_comfy_env.sh`, `install_comfy_env.ps1`, `README.md`, `CHANGELOG.md`, `pyproject.toml`
